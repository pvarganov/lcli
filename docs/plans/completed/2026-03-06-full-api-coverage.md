...
- [x] проверить, что все команды зарегистрированы в root command (rootCmd.AddCommand)
- [x] проверить, что все команды имеют --output/-o json флаг
- [x] запустить полный набор тестов (`go test ./...`)
- [x] запустить линтер (`go vet ./...`)
- [x] проверить покрытие тестов (`go test -cover ./...`)

### Task 41: Обновить документацию

- [x] обновить README.md: добавить все новые команды с примерами
- [x] добавить секцию с полным списком команд в README.md
