...
- [x] запустить полный `go test ./...` — все тесты зелёные
- [x] запустить `go vet ./...` — нет ошибок
- [x] запустить `golangci-lint run` если установлен (или `go build ./...`)
- [x] проверить `lcli issue create --help` и `lcli issue update --help` — новые флаги видны
- [x] обновить README.md если описаны команды с флагами
